...
resource "aws_ecs_service" "this" {
  ...
  # CI (deploy.yml) registers new task definition revisions and updates the
  # service directly between `terraform apply` runs. Ignoring these two
  # fields keeps Terraform from reverting CI's deploys back to whatever was
  # last applied here — Terraform owns the *infrastructure*, CI owns *which
